...
export interface TerrainParameters {
  ...
  snow_height: number;           // 0-1 (DEPRECATED: use snow_absolute_height)
  rock_height: number;           // 0-1 (DEPRECATED: use rock_absolute_height)
  grass_height: number;          // 0-1 (DEPRECATED: use grass_absolute_height)

  // v3.0: Absolute height thresholds (meters)
  snow_absolute_height: number;  // meters above which snow appears
  rock_absolute_height: number;  // meters above which rock appears
  grass_absolute_height: number; // meters below which grass appears
  ...
  noise_seed: number;            // 0-999999 (random seed for noise generation)
